...
public:
  ...
  //  FoliationDisk(const FoliationDisk& fd);
    ...
    CirclePoint FollowTheLeaf(const CirclePoint& t, int IndexOfContainingInterval); // same with the information of the containing interval.
...
private:
    ...
    int FindBetweenShiftedDivPoints(double d, int StartIndex, int EndIndex);
